...
(function(){
  ...
  HTMLElement.prototype.tip = function(text) {
    ...
    this.on({
      ...
      mouseleave:function(){
        J.id("jetTip").removeClass("j_active");
      }
    },true);
    return this
  };
  ...
  function _sortByDate(arr,attr){
    if(arr[0][attr].constructor!=Date){
